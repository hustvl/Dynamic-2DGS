...
CUDA_VISIBLE_DEVICES=2 python render_mesh.py --source_path /data3/zhangshuai/SC-2DGSv2/data/dgmesh/$dataname --model_path outputs/${dataname}_${datetime} --deform_type $d_type --hyper_dim 8 --is_blender --eval --local_frame --resolution 1
